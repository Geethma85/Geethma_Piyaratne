...
export default function App() {
  ...
  const interests = [
    "Software Engineering", "Full-Stack Development", "Mobile Development", "Quality Assurance", "AI Integration", "Agile & Scrum", "API Testing", 
     "Generative AI"
  ];
  ...
  const projects = [
    {
      ...
      desc: "A mobile application that uses facial emotion recognition to recommend music based on the user’s mood. Co-developed as a capstone project in a 5-member team, with a focus on Flutter UI development, backend integration, and emotion detection using OpenCV and DeepFace.",
      link: "#",
    ...
    },
    {
      ...
      desc: "An AI-powered university assistant designed to help students access general academic support and university-specific information. The application combines Google Gemini with Retrieval-Augmented Generation (RAG) to provide context-aware answers from official university documents, with Firebase authentication and role-based access control.",
      link: "#",
    ...
    },
    {
      title: "NovaLog",
      category: "Fullstack",
      desc: "A web application designed to help developers organize projects, track milestones, and monitor coding productivity. Built using the MERN stack, with a responsive React interface, Node.js/Express REST APIs, MongoDB data models, and JWT-based authentication.",
      github: "https://github.com/Geethma85",
      icon: "/images/3.png" 
    },
    {
      title: "CodeAcs",
      category: "Frontend",
      desc: "A static e-learning platform inspired by Coursera, designed to provide a structured and user-friendly course browsing experience. Built with HTML and CSS, featuring responsive layouts, course exploration sections, and organized learning modules.",
    ...
    },
    {
      ...
      category: "Frontend",
      desc: "A responsive personal portfolio website built with React, Vite, Tailwind CSS, and JavaScript to showcase academic achievements, technical skills, and software engineering projects. Deployed using Vercel with Git and GitHub for version control and continuous deployment.",
      link: "#",
      github: "https://github.com/Geethma85/Geethma_Piyaratne",
      icon: "/images/Garet.jpg"
    }
  ...
  {/* Navigation */}
  <nav className={`fixed top-0 left-0 w-full z-50 backdrop-blur-md border-b transition-colors ${
    isLight ? 'bg-white/80 border-neutral-200' : 'bg-neutral-900/80 border-neutral-800'
  }`}>
    ...
    {navOpen && (
      ...
      <section className="min-h-screen flex items-center pt-20 px-6 max-w-6xl mx-auto">
        <div className="flex flex-col-reverse md:flex-row items-center justify-between gap-12 w-full">
          <div className="flex-1 space-y-4 text-center md:text-left">
            ...
            {/*INTRO */}
            <div className={`max-w-xl text-base sm:text-lg leading-relaxed space-y-3 ${
          ...
          <div className={`absolute -inset-1.5 bg-gradient-to-r from-purple-600 to-pink-600 rounded-full blur-xl animate-pulse ${
            isLight ? 'opacity-20' : 'opacity-50'
          }`}></div>
            <img 
              src="/images/final.jpeg" 
              alt="Geethma Piyaratne" 
              className={`relative w-64 h-64 sm:w-80 sm:h-80 md:w-96 md:h-96 rounded-full object-cover ring-4 ${
                isLight ? 'ring-neutral-200' : 'ring-neutral-800'
              }`}
            />
          </div>
        </div>
      ...
      <h2 className={`text-3xl font-bold mb-6 ${isLight ? 'text-neutral-900' : 'text-white'}`}>About Me</h2>
      <div className={`leading-relaxed max-w-3xl text-lg space-y-4 mb-12 ${isLight ? 'text-neutral-900' : 'text-neutral-400'}`}>
  <p>
  ...
  <p>
  <span className={`font-medium ${isLight ? 'text-neutral-900' : 'text-neutral-200'}`}>My interests include</span> web development, mobile app development, Generative AI, and QA/testing. I’m currently focused on expanding my technical skills, building projects, and gaining hands-on experience with modern technologies.
  </p>
</div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className={`p-6 rounded-2xl border transition-all ${
          isLight ? 'bg-white border-neutral-200 hover:border-purple-400' : 'bg-neutral-900/60 border-neutral-800 hover:border-purple-500/50'
        }`}>
          <h3 className={`text-xl font-semibold mb-4 ${isLight ? 'text-neutral-900' : 'text-white'}`}>Education</h3>
          <div className="space-y-4">
            <div className="flex items-center gap-4">
              <img src="/images/SUSL_logo2.png" alt="SUSL" className="w-12 h-12 object-contain" />
              <div>
                <h4 className={`font-medium ${isLight ? 'text-neutral-900' : 'text-neutral-200'}`}>Sabaragamuwa University of Sri Lanka</h4>
                <p className={`text-sm ${isLight ? 'text-neutral-700' : 'text-neutral-400'}`}>BSc (Hons) in Information Systems</p>
              </div>
            </div>
            <div className="flex items-center gap-4">
              <img src="/images/Musaeus_College_crest.png" alt="Musaeus" className="w-12 h-12 object-contain" />
              <div>
                <h4 className={`font-medium ${isLight ? 'text-neutral-900' : 'text-neutral-200'}`}>Musaeus College</h4>
        ...
        <div className={`p-6 rounded-2xl border transition-all ${
          ...
          <h3 className={`text-xl font-semibold mb-4 ${isLight ? 'text-neutral-900' : 'text-white'}`}>Focus & Interests</h3>
          <div className="flex flex-wrap gap-2">
            {interests.map((interest, idx) => (
              <span 
                key={idx} 
                className={`px-3 py-1.5 rounded-lg text-sm font-medium border ${
                  isLight ? 'bg-purple-100 text-purple-700 border-purple-300' : 'bg-purple-950/40 text-purple-300 border-purple-800/40'
                }`}
              >
                {interest}
              </span>
      ...
      <h2 className={`text-3xl font-bold mb-12 text-center md:text-left ${isLight ? 'text-neutral-900' : 'text-white'}`}>Technical Skills</h2>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-12">
  
      {/* Languages */}
      <div className={`p-8 min-h-[240px] rounded-2xl border text-center flex flex-col items-center justify-center hover:scale-[1.02] transition-all ${
        isLight ? 'bg-white border-neutral-200 shadow-sm hover:border-purple-400' : 'bg-neutral-900/60 border-neutral-800 hover:border-purple-500/50'
      }`}>
        ...
        <h3 className={`text-xl font-semibold ${isLight ? 'text-neutral-900' : 'text-white'}`}>Languages</h3>
      </div>
      ...
      <div className={`p-8 min-h-[240px] rounded-2xl border text-center flex flex-col items-center justify-center hover:scale-[1.02] transition-all ${
        ...
        <h3 className={`text-xl font-semibold ${isLight ? 'text-neutral-900' : 'text-white'}`}>Frontend & Mobile</h3>
      </div>
      ...
      <div className={`p-8 min-h-[240px] rounded-2xl border text-center flex flex-col items-center justify-center hover:scale-[1.02] transition-all ${
        ...
        <h3 className={`text-xl font-semibold ${isLight ? 'text-neutral-900' : 'text-white'}`}>Databases</h3>
      </div>

    </div>

        {/* Updated Skills Summary */}
        <p className={`leading-relaxed text-center max-w-3xl mx-auto ${isLight ? 'text-neutral-900' : 'text-neutral-400'}`}>
      ...
      <section id="projects" className="py-24 px-6 max-w-6xl mx-auto border-t border-neutral-900">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-8 gap-4">
          <div>
          <h2 className={`text-3xl font-bold mb-2 ${isLight ? 'text-neutral-900' : 'text-white'}`}>Projects</h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          {filteredProjects.map((p, idx) => (
            <div key={idx} className={`p-6 rounded-2xl border flex flex-col justify-between group transition-all ${
              isLight ? 'bg-white border-neutral-200 shadow-sm hover:border-purple-400' : 'bg-neutral-900/60 border-neutral-800 hover:border-purple-500/50'
            }`}>
              <div>
                <div className="flex items-center gap-3 mb-3">
                  {p.icon && (
                    <img 
                      src={p.icon} 
                      alt={p.title} 
                      className={`w-10 h-10 object-contain rounded-lg p-1.5 border ${isLight ? 'bg-neutral-100 border-neutral-200' : 'bg-neutral-800 border-neutral-700'}`} 
                      onError={(e) => { e.target.style.display = 'none'; }}
                    />
                  )}
                  <h3 className={`text-xl font-semibold group-hover:text-purple-400 transition-colors ${isLight ? 'text-neutral-900' : 'text-white'}`}>
                    {p.title}
                  </h3>
                </div>
                <p className={`text-sm leading-relaxed mb-6 ${isLight ? 'text-neutral-900' : 'text-neutral-400'}`}>{p.desc}</p>
              </div>
              <div className="flex items-center gap-4 text-sm font-medium">
                ...
                <a href={p.github} target="_blank" rel="noreferrer" className={`flex items-center gap-1.5 transition-colors ${
                  isLight ? 'text-neutral-900 hover:text-purple-600' : 'text-neutral-300 hover:text-white'
                }`}>
                  GitHub <FaGithub />
                </a>
              </div>
      ...
      <h2 className={`text-3xl font-bold mb-12 text-center ${isLight ? 'text-neutral-900' : 'text-white'}`}>Certifications</h2>
      ...
      <section id="volunteering" className={`py-24 px-6 max-w-6xl mx-auto border-t transition-colors ${isLight ? 'border-neutral-200' : 'border-neutral-900'}`}>
        <h2 className={`text-3xl font-bold mb-12 ${isLight ? 'text-neutral-900' : 'text-white'}`}>Leadership & Volunteering</h2>
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">

          {/* Rotaract SDG */}
          <div className={`rounded-2xl overflow-hidden border hover:scale-[1.02] transition-all flex flex-col justify-between ${
            isLight ? 'bg-white border-neutral-200 shadow-sm hover:border-purple-400' : 'bg-neutral-900/60 border-neutral-800 hover:border-purple-500/50'
          }`}>
            <img src="/images/sdgpic.jpg" alt="Rotaract SDG" className="w-full h-44 object-cover" />
            <div className="p-5 flex-1 flex flex-col justify-between">
              <div>
                <h3 className={`font-semibold text-lg ${isLight ? 'text-neutral-900' : 'text-white'}`}>Rotaract — SDG Task Force</h3>
                <p className="text-purple-500 text-sm font-medium mb-2">Chairperson — SDG 10</p>
          ...
          <div className={`rounded-2xl overflow-hidden border hover:scale-[1.02] transition-all flex flex-col justify-between ${
            ...
            <div className="p-5 flex-1 flex flex-col justify-between">
              <div>
                <h3 className={`font-semibold text-lg ${isLight ? 'text-neutral-900' : 'text-white'}`}>Rotaract Club</h3>
                <p className="text-purple-500 text-sm font-medium mb-2">Social Media Team (YouTube) • 2025–2026</p>
                <p className={`text-sm leading-relaxed ${isLight ? 'text-neutral-900' : 'text-neutral-400'}`}>
          ...
          <div className={`rounded-2xl overflow-hidden border hover:scale-[1.02] transition-all flex flex-col justify-between ${
            ...
            <div className="p-5 flex-1 flex flex-col justify-between">
              <div>
                <h3 className={`font-semibold text-lg ${isLight ? 'text-neutral-900' : 'text-white'}`}>IEEE PearlHack 2.0</h3>
                <p className="text-purple-500 text-sm font-medium mb-2">Secretary Team Member</p>
                <p className={`text-sm leading-relaxed ${isLight ? 'text-neutral-900' : 'text-neutral-400'}`}>
